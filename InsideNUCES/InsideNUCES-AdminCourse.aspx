<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsideNUCES-AdminCourse.aspx.cs" Inherits="InsideNUCES.InsideNUCES_AdminCourse" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Courses Database - InsideNUCES</title>
    <style>
...
<body>
    <form id="form1" runat="server" onsubmit="return validateForm()">
        <div class="inputBox">
            <input type="text" required="required" id="CourseNameTB" />
...
<script>
    function getImageClickData() {
        var courseTBValue = document.getElementById("CourseNameTB").value;
