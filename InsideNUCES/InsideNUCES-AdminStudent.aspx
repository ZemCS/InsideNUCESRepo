<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsideNUCES-AdminStudent.aspx.cs" Inherits="InsideNUCES.InsideNUCES_AdminStudent" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Students Database - InsideNUCES</title>
    <style>
...
<body>
    <form id="form1" runat="server" onsubmit="return validateForm()">
        <div class="inputBox">
            <input type="text" required="required" id="StudentNameTB" />
        ...
        <asp:HiddenField ID="HiddenStudentName" runat="server" />
...
<script>
    function getImageClickData() {
        var studentTBValue = document.getElementById("StudentNameTB").value;
        var columnTBValue = document.getElementById("ColumnNameTB").value;
        var entryTBValue = document.getElementById("EntryTB").value;
        if (studentTBValue.trim() === '' || columnTBValue.trim() === '' || entryTBValue.trim() === '') {
            alert('Please fill in all fields.');
            return false;
        }
        document.getElementById("<%= HiddenStudentName.ClientID %>").value = studentTBValue;
